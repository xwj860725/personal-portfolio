        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <div className="navbar-content">
            ...
            <div className="navbar-actions">
              ...
              <div className="social-icon">
                <button type="button" className="icon-btn" aria-label="social 1">
                  <img src={navIcon1} alt="Social icon 1" />
                </button>
                <button type="button" className="icon-btn" aria-label="social 2">
                  <img src={navIcon2} alt="Social icon 2" />
                </button>
                <button type="button" className="icon-btn" aria-label="social 3">
